...
void min_operations_to_transform(int t, vector<pair<int, pair<vector<int>, vector<int> > > >& test_cases) {
    for (int i = 0; i < t; ++i) {
        int n = test_cases[i].first;
        vector<int>& a = test_cases[i].second.first;
        vector<int>& b = test_cases[i].second.second;
        ...
        long long min_operations = abs(sum_b - sum_a);
...
int main() {
    int t;
    cin >> t;
    vector<pair<int, pair<vector<int>, vector<int> > > > test_cases(t);
    ...
    for (int i = 0; i < t; ++i) {
        ...
        test_cases[i] = make_pair(n, make_pair(a, b));
    }

    min_operations_to_transform(t, test_cases);
